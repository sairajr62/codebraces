...
const Contact = () => {
  ...
  return (
    <div className="bg-[#0b0c0e] text-gray-200 min-h-screen">
      ...
      {/* Header */}
      <section className="relative pt-12 pb-16 border-b border-white/10 overflow-hidden">
        <Spotlight className="-top-40 left-0 md:left-60 md:-top-20" fill="#FD6703" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-4">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#181a22] text-[#FD6703] border border-[#FD6703]/30 text-xs font-bold uppercase tracking-wider"
          >
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight">
            <TextGenerateEffect words="Let's Discuss Your Next Project" />
          </h1>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          {/* Form Side (8 Cols) */}
          <div className="lg:col-span-8 relative bg-[#121419] rounded-3xl border border-white/10 p-6 sm:p-10 shadow-2xl overflow-hidden">
            <BorderBeam size={250} duration={12} colorFrom="#FD6703" colorTo="#ff7e29" />
              ...
              {isSubmitted ? (
                ...
                >
                      ...
                      {categories.map((cat) => {
                        ...
                        return (
                          <button
                            ...
                            className={`relative p-3 rounded-xl text-left border text-xs font-semibold flex items-center gap-2.5 transition-all ${
                              isSelected
                                ? 'text-white border-[#FD6703]'
                          ...
                          >
                            {isSelected && (
                              <motion.div
                                ...
                                className="absolute inset-0 bg-[#FD6703] rounded-xl shadow-md"
                                initial={false}
                                transition={{ type: "spring", stiffness: 500, damping: 30 }}
                              />
                            )}
                            <Icon className={`w-4 h-4 shrink-0 relative z-10 ${isSelected ? 'text-white' : 'text-[#FD6703]'}`} />
                  ...
                  <button
                    ...
                    className="w-full py-4 rounded-xl font-bold bg-[#FD6703] text-white hover:bg-[#e65c00] transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#FD6703]/20 disabled:opacity-50"
                  >
                    {isSubmitting ? (
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <FadeInSection direction="up">
              <CardSpotlight className="bg-[#121419] rounded-3xl border border-white/10 p-6 space-y-6" spotlightColor="rgba(253, 103, 3, 0.1)">
                <h3 className="text-lg font-bold text-white pb-3 border-b border-white/10 relative z-10">
